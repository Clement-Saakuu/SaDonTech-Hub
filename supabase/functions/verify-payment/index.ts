...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const paidAmount = verifyData.data.amount / 100; // Paystack uses kobo/pesewas
    ...
    // Extend from whichever is later: today, or their current paid-until
    // date (so paying early doesn't waste days already covered).
